          ...
          <form onSubmit={handleSubmit}>
            {step === 1 && (
              <>
                ...
                <button type="button" className="next-button" onClick={handleNextStep} disabled={isSubmitting}>
                  Next
                </button>
              </>
            )}
            {step === 2 && (
              <>
                ...
                <button type="button" className="prev-button" onClick={handlePrevStep} disabled={isSubmitting}>
                  Previous
                </button>
                <button type="button" className="next-button" onClick={handleNextStep} disabled={isSubmitting}>
                  Next
